...
//                mDayStyle = a.getInt(R.styleable.AbstractCalendarView_dayStyle, DayStyleFactory.DEFAULT_STYLE);
    ...
    protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
        ...
        int textWidthMeasureSpec = MeasureSpec.makeMeasureSpec(measuredWidth / daysInRow,
                MeasureSpec.AT_MOST);
        int textHeightMeasureSpec = MeasureSpec.makeMeasureSpec(0, MeasureSpec.UNSPECIFIED);
        ...
        if (this instanceof MultiCalendarView) {
            ...
            int indicatorWidthMeasureSpec = MeasureSpec.makeMeasureSpec(
                    resolveSize(measuredWidth, widthMeasureSpec), MeasureSpec.EXACTLY);
            int indicatorHeightMeasureSpec = MeasureSpec.makeMeasureSpec(0, MeasureSpec.UNSPECIFIED);
            ...
            indicatorHeightMeasureSpec = MeasureSpec.makeMeasureSpec(measuredHeight, MeasureSpec.EXACTLY);
